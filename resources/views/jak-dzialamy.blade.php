...
@section('content')
  ...
  <div class="jak-dzialamy-page">
    ...
    alt="jak działamy" data-aos="zoom-in"/>
  ...
  <div class="container">
    ...
    <h2 data-aos="zoom-in">Etapy współpracy</h2>
      ...
      <p style=" font-size:18px;"> Uruchomienie kampanii, pomiar jej efektów, stały kontakt z Klientem i Twórcami -to wszystko Folks podsumowuje w ramach sumarycznego raportu, dbając o jak najdokładniejszą analitykę kampanii.
        ...
        <div class="col-sm-4">
          ...
          alt="Dołącz" data-aos="zoom-in"/>
            ...
            <a class="btn-effect center" href="/dolacz/" target="_self" rel="nofollow noopener" data-aos="zoom-in">Dołącz do nas</a>
      </div>
    </div>
    ...
    <div class="etapy-wspolpracy mobile-size d-block d-lg-none">
      <div class="row">
        <div class="col-sm-4">
          <div class="row">
            ...
            <div class="col-3">
              <img src=" {{get_stylesheet_directory_uri()}}/assets/images/new/jak-dzialamy1.png" alt="Dołącz" data-aos="zoom-in"/>
            </div>
          </div>
      ...
      <p style=" font-size:18px;" data-aos="zoom-in"> W pierwszym etapie działań ustalane są główne cele biznesowo - wizerunkowe Klienta, których realizacja jest możliwa dzięki wsparciu wpływowych Twórców. Określane są potrzeby i możliwości
        ...
        <div class="col-sm-8 znajdz-toworce-opis">
          <div class="row">
            ...
            <div class="col-3">
              <img src=" {{get_stylesheet_directory_uri()}}/assets/images/new/jak-dzialamy2.png" alt="Dołącz" data-aos="zoom-in"/>
            </div>
          </div>
      ...
      <p style=" font-size:18px;" data-aos="zoom-in"> Po potwierdzeniu listy Twórców – Folks finalizuje ustalenia, negocjuje warunki umów, potwierdza ustalenia i założenia projektowe.
        ...
        <div class="col-sm-8 znajdz-toworce-opis">
          <div class="row">
            <div class="col-9">
              <h3 data-aos="zoom-in"><span>4.</span> Monitorowanie<br> i opieka</h3>
            </div>
            <div class="col-3">
              <img src=" {{get_stylesheet_directory_uri()}}/assets/images/new/jak-dzialamy4.png" alt="Dołącz" data-aos="zoom-in"/>
            </div>
          </div>

      <p style=" font-size:18px;" data-aos="zoom-in"> Uruchomienie kampanii, pomiar jej efektów, stały kontakt z Klientem i Twórcami -to wszystko Folks podsumowuje w ramach sumarycznego raportu, dbając o jak najdokładniejszą analitykę kampanii.
      </p>
        </div>


            <a class="btn-effect center" style="max-width:95%" href="/dolacz/" target="_self" rel="nofollow noopener" data-aos="zoom-in">Dołącz do nas</a>
      </div>
    </div>
