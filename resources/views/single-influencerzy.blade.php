          ...
          <div class="social-links">
            ...
            @endphp
              ...
              @endif
               ...
               @php $havefb = get_user_meta($curauth -> ID , 'social_profile_ln', true); @endphp
               @php
                   $tikTokGroup = get_field('tik_tok');
               @endphp
               @php $tikTok = $tikTokGroup['tik_tok-acf'] @endphp
               {{-- @php ddd($tikTok) @endphp --}}
               @php $havefb = get_user_meta($curauth -> ID , $linkedind['social_profile_ln'], true); @endphp
               @if ($tikTok)
                   <a class="icon linked-in" href="{{$tikTok}}" title="TikTok">
                     <div class="ir">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="35" height="30" viewBox="-5 -2 35 35">
                        <image id="Warstwa_1" data-name="Warstwa 1" width="25" height="30" xlink:href="data:img/png;base64,"/>
                      </svg>
